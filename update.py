...
try:
    ...
    UPSTREAM_REPO = "https://github.com/jackssmit/Jackssmit-Deploy"
try:
...
update = srun([f"git init -q \
                 && git config --global user.email jackssmit@progithub.com \
...
if update.returncode == 0:
    ...
    log_info('Easy cheesy redeploying By Developer Jack')
else:
